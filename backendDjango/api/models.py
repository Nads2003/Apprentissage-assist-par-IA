...
class Exercice(models.Model):
    ...
    def __str__(self):
        return f"Exercice: {self.titre} ({self.cours.titre})"
...
class ExplicationCours(models.Model):
    ...
    # Explication peut être audio OU vidéo OU texte
    audio = models.FileField(upload_to="explications/audio/", blank=True, null=True)
    video = models.FileField(upload_to="explications/video/", blank=True, null=True)
